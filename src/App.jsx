...
import unfluke from './assets/unfluke.png'; // Adjust the path to your logo image
import bellIcon from './assets/bell.png'; // Adjust the path to your bell icon
import coinIcon from './assets/coin.jpg'; // Adjust the path to your coin icon
import profileIcon from './assets/monkey.png'; // Adjust the path to your profile icon
